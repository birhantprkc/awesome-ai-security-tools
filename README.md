...
- **[Clay Seal Identity](https://github.com/clayseal/clayseal-identity)** 🟢 — Short-lived attested credentials for AI agents (SPIFFE-shaped IDs, holder-bound tokens, offline verification) plus optional FastMCP tool authorization. *(Clay Seal)* `pip install clayseal-identity`. *(★ 7 · updated 2026-08)*
  - **Related:** [onecli](https://github.com/onecli/onecli) · [ToolHive](https://github.com/stacklok/toolhive)
- **[Clay Seal Receipts](https://github.com/clayseal/clayseal-receipts)** 🟢 — Policy wrap and signed offline-verifiable action receipts for AI agent tool calls (shadow mode first). *(Clay Seal)* *(★ 2 · updated 2026-08)*
  - **Related:** [HELM AI Kernel](https://github.com/Mindburn-Labs/helm-ai-kernel) · [Nobulex](https://github.com/arian-gogani/nobulex)
